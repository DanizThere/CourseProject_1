            ...
            { initialData && <form>
                ...
                <table>
                    ...
                    <tr>
                            ...
                            <input type="number" name="id_customer" defaultValue={initialData.id_customer} readOnly></input>
                        </tr>
                        <tr>
                            <label>Итоговая цена</label>
                            <input type="number" name="total_cost" defaultValue={initialData.total_cost} readOnly></input>
                        </tr>
                        <tr>
                            <label>Адрес</label>
                            <input type="number" name="address" defaultValue={initialData.address} readOnly></input>
                        </tr>
                        <tr>
                            <label>Дата заказа</label>
                            <input type="date" name="date_of_order" defaultValue={initialData.date_of_order} readOnly></input>
                        </tr>
                    </tbody>
                </table>
